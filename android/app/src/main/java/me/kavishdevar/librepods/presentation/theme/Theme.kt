...
/**
 * The hairline between two rows of one card. A single translucent grey cannot land
 * on Apple's value in both themes - a quarter-strength #888888 sits right on the
 * dark card's #38383A but comes out six levels dark on a white one - so each theme
 * carries the colour measured off its own captures.
 */
