...
uv run --with usd-core python prepare.py --source apple_airpods_pro_2.usdz --out prepared
Apple's 2022 USDZ also has a MaterialX output, which Blender 5.2 imports without
