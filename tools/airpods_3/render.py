"""Render the AirPods 3 rig to transparent PNGs; encode.py makes Android assets."""
import argparse
import math
import json
import sys
...
def hide_group(key):
    for o in bpy.data.collections['AirPods3_' + key].objects: o.hide_render = True
...
shared = apply_shared_studio('airpods_3', a.mode)
...
for i in indices:
    ...
    if a.mode in ['connected', 'island']:
        ...
        case['lid_open_degrees'] = 110 * (1 - math.cos(theta)) / 2
