...
uv run --with usd-core python prepare.py --source apple_airpods_pro_1.usdz --out prepared
Older Apple USDZ files may have a MaterialX output, which Blender 5.2 imports
without its texture networks. Remove only that competing output on a derivative copy;
